...
export const partyKeys: (keyof Party)[] = [
  ...
  export const provinces: Province[] = [
    { 
        ...
        parties: {
          ...
          centro: {
              ...
              senate: {bancas: 27, loseBancas: 8, renewBancas: 4}
          },
          liberalismo: {
              deputies: {bancas: 39, loseBancas: 8, renewBancas: 64},
              senate: {bancas: 6, loseBancas: 0, renewBancas: 13}
          }
        }  
    },
    { 
    ...
    },
    {
      ...
      parties: {
        peronismo: {
          deputies: { bancas: 24, loseBancas: 13, renewBancas: 11 },
          senate: { bancas: 14, loseBancas: 6, renewBancas: 6 }
        },
        socialismo: {
        ...
        centro: {
          deputies: { bancas: 13, loseBancas: 8, renewBancas: 4 },
          senate: { bancas: 2, loseBancas: 2, renewBancas: 1 }
        },
        liberalismo: {
          deputies: { bancas: 4, loseBancas: 0, renewBancas: 6 },
    ...
    },
    {
      ...
      parties: {
        peronismo: {
          deputies: { bancas: 7, loseBancas: 3, renewBancas: 3 },
          senate: { bancas: 3, loseBancas: 1, renewBancas: 1 }
        },
        socialismo: {
          deputies: { bancas: 0, loseBancas: 0 },
          senate: { bancas: 0, loseBancas: 0 }
        ...
        centro: {
          deputies: { bancas: 17, loseBancas: 8, renewBancas: 11 },
          senate: { bancas: 11, loseBancas: 4, renewBancas: 4 }
        },
        liberalismo: {
          deputies: { bancas: 6, loseBancas: 4, renewBancas: 1 },
    ...
    },
    {
      ...
      population: 482733,
      parties: {
        peronismo: { deputies: { bancas: 22, loseBancas: 9, renewBancas: 11 } },
        socialismo: { deputies: { bancas: 0, loseBancas: 0 } },
        centro: { deputies: { bancas: 8, loseBancas: 6, renewBancas: 3 } },
        liberalismo: { deputies: { bancas: 0, loseBancas: 0, renewBancas: 1 } }
      }
    },
    {
      id: "jujuy",
    ...
    },
    {
      ...
      population: 304344,
      parties: {
        peronismo: { deputies: { bancas: 32, loseBancas: 15, renewBancas: 9 } },
        socialismo: { deputies: { bancas: 0, loseBancas: 0 } },
        centro: { deputies: { bancas: 2, loseBancas: 1, renewBancas: 1 } },
        liberalismo: { deputies: { bancas: 2, loseBancas: 2, renewBancas: 8 } }
      }
    },
    {
      id: "mendoza",
      ...
      parties: {
        peronismo: {
          deputies: { bancas: 10, loseBancas: 7, renewBancas: 6 },
        ...
        centro: {
          deputies: { bancas: 29, loseBancas: 15, renewBancas: 7 },
          senate: { bancas: 20, loseBancas: 9, renewBancas: 6 }
        },
        liberalismo: {
          deputies: { bancas: 9, loseBancas: 0, renewBancas: 7 },
          senate: { bancas: 8, loseBancas: 3, renewBancas: 5 }
        }
      }
    },
    {
    ...
    },
    {
      ...
      population: 813802,
      parties: {
        peronismo: { deputies: { bancas: 12, loseBancas: 12, renewBancas: 13 } },
        socialismo: { deputies: { bancas: 0, loseBancas: 0 } },
        centro: { deputies: { bancas: 28, loseBancas: 28, renewBancas: 22 } },
        liberalismo: { deputies: { bancas: 0, loseBancas: 0, renewBancas: 5 } }
      }
    },
    {
      id: "tierra-del-fuego",
